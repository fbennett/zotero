...
function publish-update () {
    ...
    uhura -o update-TRANSFER.rdf -k ~/juris-m-distrib-keys/keyfile.pem -p =Lnosiatl "${RELEASE_DIR}/${CLIENT}-v${VERSION}.xpi" "https://github.com/Juris-M/${FORK}/releases/download/v${VERSION_STUB}/${CLIENT}-v${VERSION}.xpi"
